...
class GameResource():
    ...
    @staticmethod
    def load_newgame_tip_img():
        if not GameResource.newgame_tip_img:
            GameResource.newgame_tip_img = pygame.image.load(GameResource.img_path + "press_r_new_game.png").convert_alpha()
        return GameResource.newgame_tip_img